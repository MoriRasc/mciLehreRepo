...
In diesem Praktikum wird die Muskelaktivität des Bizeps Brachii untersucht. Die beiden Messelektroden sollten einen Abstand von 2 cm von Elektrodenmitte zu Elektrodenmitte aufweisen und entlang des Muskels auf dem Muskelbauch platziert sein. Die Referenzelektrode sollte wie bei der Elektrokardiografie an einem sehr knöchernen Körperteil mit wenig Muskelaktivität angebracht werden.
  ...
  - Rote Elektrode in Richtung der Sehne, siehe Abbildung 1.2.
...
![Abbildung 1.2](../assets/img/emgElekt.jpg)

[Abbildung 1.2](../assets/img/emgElekt.jpg): Elektrode Platzierung auf der Muskel.
...
mit GND und gelb mit A0 zu verbinden und mit einem Schraubenzieher festzuziehen (siehe Abbildung 1.3).

![Abbildung 1.3](../assets/img/Channels_Sparkfun_AD12.JPG)

[Abbildung 1.3](../assets/img/Channels_Sparkfun_AD12.JPG ): SparkFun ADS1015 ADC Board.
