...
1. Erstellen Sie Diagramme, in denen das kabellose Messsystem dargestellt ist. Beschriften Sie jede Komponente, jeden Bus (einschließlich Bustyp und -geschwindigkeit) sowie jeden Signalpfad, und beschreiben Sie diese jeweils kurz. (1-2 Sätze pro Komponente). 

2. Arbeiten Sie folgende Fragen aus  :
...
einen Wert von 520 ausgibt? Zeigen Sie Ihre Rechnung! 

4. Wenn Sie den Reset Button betätigen, startet ihr Mikrocontroller den Code neu. Geschieht dies aus der Setup- oder aus der Loop-Funktion? Wenn Sie die elektrische Aktivität Ihres Bizeps messen möchten, in welcher der beiden genannten Funktionen würden Sie Ihren Code hineinschreiben? 
...
unten oder oben zeigt. Ergeben die Daten Sinn? 
...
7. Geben Sie die essenziellen Zeilen des Filter-Algorithmus in Python an. 
